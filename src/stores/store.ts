...
export const useStore = defineStore({
	...
	state: () => ({
		...
		panels: [
			...
			{ id: 1, neg: false, expanded: false, change: false, title: 'Сервер DV' },
			{ id: 2, neg: false, expanded: false, change: false, title: 'Подключенные базы данных' },
			{ id: 3, neg: false, expanded: false, change: false, title: 'Настройка клиентской части' },
			{ id: 4, neg: false, expanded: false, change: false, title: 'Управление доступом' },
			{ id: 5, neg: false, expanded: false, change: false, title: 'Общие настройки серверной консоли' },
			{ id: 6, neg: false, expanded: false, change: false, title: 'Управление бизнес-процессами' },
			{ id: 7, neg: false, expanded: false, change: false, title: 'Настройки сервиса WorkFlow' },
			{ id: 8, neg: false, expanded: false, change: false, title: 'Почтовые настройки сервиса Workflow' },
		],
		server: useServer(),
		access: useAccess(),
	}),
