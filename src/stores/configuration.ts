...
export const useConfig = defineStore({
	...
	state: () => ({
		...
		rows: [
			{
				id: 0, name: 'Config 1', env: 'test', module: 'Web-client', selected: true, computers: [
			...
			{
				id: 6, name: 'Config 2', env: 'prod', module: 'Web-client', selected: false, computers: [
					{ id: 0, name: 'DVM', os: 'Linux', selected: false },
				]
			},
			{
				id: 1, name: 'Config 3', env: 'test', module: 'Platform', selected: false, computers: [
					{ id: 0, name: 'DVM', os: 'Linux', selected: false },
					{ id: 1, name: '104pc0104', os: 'Linux', selected: false },
				]
			},
			{
				id: 2, name: 'Config 4', env: 'prod', module: 'Platform', selected: false, computers: [
					{ id: 0, name: '104pc0104', os: 'Linux', selected: false },
				]
			},
			{
				id: 7, name: 'Config 5', env: 'test', module: 'Workflow', selected: false, computers: [
					{ id: 1, name: 'DV-test', os: 'Windows', selected: false },
					{ id: 2, name: 'DVM', os: 'Linux', selected: false },
				]
			},
			{
				id: 3, name: 'Config 6', env: 'prod', module: 'Workflow', selected: false, computers: [
					{ id: 0, name: '102pc0102', os: 'Windows', selected: false },
					{ id: 3, name: '104pc0104', os: 'Linux', selected: false },
				]
			},
			{
				id: 4, name: 'Config 7', env: 'test', module: 'Server DV', selected: false, computers: [
					{ id: 1, name: 'DV-test', os: 'Windows', selected: false },
					{ id: 2, name: 'DVM', os: 'Linux', selected: false },
		...
		columns1: [
			{ label: 'Компьютер', align: 'left', sortable: true, name: 'name', field: 'name' },
